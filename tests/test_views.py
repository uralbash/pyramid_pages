...
class GetTreeTest(BaseTest):
    ...
    def test_it(self):
        ...
        request.set_property(mock_dbsession, 'dbsession', reify=True)
        response = self._callFUT(request)
        self.assertEqual([{'visible': True, 'children': [{'visible': True, 'children': [{'visible': True, 'id': 3, 'label': 'And Pyramid'}], 'id': 2, 'label': 'We \xe2\x99\xa5  gevent'}, {'visible': False, 'children': [{'visible': True, 'id': 5, 'label': 'foo'}, {'visible': False, 'id': 6, 'label': '\xd0\xba\xd0\xbe\xd0\xbc\xd0\xbf\xd0\xb0\xd0\xbd\xd0\xb8\xd1\x8f ITCase'}], 'id': 4, 'label': 'Our history'}, {'visible': True, 'children': [{'visible': True, 'children': [{'visible': False, 'id': 9, 'label': 'Technology'}], 'id': 8, 'label': 'Wordwide'}, {'visible': True, 'children': [{'visible': True, 'id': 11, 'label': 'at a glance'}], 'id': 10, 'label': 'What we do'}], 'id': 7, 'label': 'Our strategy'}], 'id': 1, 'label': 'About company'}, {'visible': True, 'children': [{'visible': False, 'children': [{'visible': False, 'id': 14, 'label': 'foo14'}], 'id': 13, 'label': 'foo13'}, {'visible': True, 'children': [{'visible': True, 'id': 16, 'label': 'foo16'}, {'visible': True, 'id': 17, 'label': 'foo17'}], 'id': 15, 'label': 'foo15'}, {'visible': True, 'children': [{'visible': True, 'children': [{'visible': True, 'id': 20, 'label': 'foo20'}], 'id': 19, 'label': 'foo19'}, {'visible': True, 'children': [{'visible': True, 'id': 22, 'label': 'foo22'}], 'id': 21, 'label': 'foo21'}], 'id': 18, 'label': 'foo18'}], 'id': 12, 'label': 'foo12'}],
                         response)
